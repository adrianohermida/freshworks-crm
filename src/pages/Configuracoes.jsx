...
export default function Configuracoes() {
  ...
  const modules = [
    ...
    {
      title: 'Integrações',
      description: 'WhatsApp, Email, Calendário',
      icon: Plug,
      path: createPageUrl('ConfiguracoesIntegracoes'),
      color: 'text-orange-600',
      bgColor: 'bg-orange-50'
    },
    {
      title: 'Conectores & APIs',
      description: 'Gerencie provedores, endpoints e testes de API',
      icon: Plug,
      path: createPageUrl('Conectores'),
      color: 'text-cyan-600',
      bgColor: 'bg-cyan-50'
    },
    {
      title: 'Plataforma',
      description: 'Gerenciar sistema e configurações avançadas',
      icon: Database,
