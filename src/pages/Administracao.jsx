...
import { 
  ...
  FolderOpen, Shield, ChevronRight, Plug
} from 'lucide-react';
...
const adminModules = [
  ...
  {
    title: 'Configurações & Conectores',
    description: 'Personalize o sistema, integrações e APIs',
    icon: Settings,
  ...
  return (
    <InstrumentedErrorBoundary category="ROUTES">
      <div className="p-6 max-w-7xl mx-auto">
        ...
        {escritorio && (
          <Card 
            className="mb-8 bg-gradient-to-r from-[var(--brand-primary-50)] to-white border-[var(--brand-primary-200)]"
            data-testid="escritorio-summary"
          >
            <CardHeader>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {adminModules.map((module) => (
            <Link key={module.url} to={module.url}>
              <Card 
                className="h-full hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer group"
