...
import { Plug, TestTube, Activity, ChevronRight, Mail } from 'lucide-react';
import { Link } from 'react-router-dom';

const integrationModules = [
  {
    title: 'Email (IMAP/SMTP)',
    description: 'Configure Base44 Mail + Yandex SMTP',
    icon: Mail,
    url: createPageUrl('Settings') + '?tab=email',
    color: 'text-red-600',
    bgColor: 'bg-red-100',
  },
  {
    title: 'Worker IMAP Yandex',
    description: 'Sincronize emails via Cloudflare Worker',
    icon: Mail,
    url: createPageUrl('Settings') + '?tab=email-worker',
