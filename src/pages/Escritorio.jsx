  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)]">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="mt-6" data-testid="form-unidades">
